...
export type SkillBenchVariant = { batchId: string; environment: SkillBenchConfig["environment"]; skillId: UpgradeId | "original"; level: 0 | 1 | 2 | 3; skillValues: [number, number, number]; skillFingerprint?: string; seed: number };
...
export type GameState = {
  ...
  skillBarrierTime: number;
  skillBarrierCharges: number;
