...
export const SKILL_EVOLUTIONS: Partial<Record<BuiltinClassSkillId, string>> = {
  ...
  "warrior-guard": "철벽 보호막의 유지시간이 사라집니다.",
...
export const DEFAULT_SKILLS: SkillConfig[] = [
  ...
  skill("warrior-guard", "철벽", "warrior", "블록 타격 시 자동 발동", "CORE 보호막 충전", "CORE 피해를 한 번 막는 보호막을 얻습니다. 보호막은 {levels}초 후 사라지며, 진화 후에는 유지시간이 없습니다. 발동 쿨타임은 {cooldown}초입니다.", [2, 3, 4], "seconds"),
